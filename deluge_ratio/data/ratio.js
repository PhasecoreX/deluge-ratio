 ...
 *
 * Copyright:
 *     (C) Maximilian Meier 2022 <maximilian.meier@tum.de>
 *
...
new RatioPlugin();
 ...
 Deluge.Statusbar = Ext.extend(Ext.ux.StatusBar, {
    ...
    update: function (stats) {
        ...
        deluge.client.ratio.get_ratio_and_totals({
                success: function (ratio_and_totals) {
                    //console.log("ratio: " + ratio_and_totals["ratio"])
                    this.items
                        .get('statusbar-ratio')
                        .setText(
                            String.format(
                                _('<b>Ratio</b> {0} ({1}/{2})'),
                                ratio_and_totals["ratio"],
                                ratio_and_totals["upload"],
                                ratio_and_totals["download"]
                            )
            );
                },
                scope: this
